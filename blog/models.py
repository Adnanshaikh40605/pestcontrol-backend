...
from backend.media_storage import (
    blog_featured_upload_path,
    blog_thumbnail_upload_path,
    blog_medium_upload_path,
...
class Blog(BaseModel):
    ...
    featured_image = models.ImageField(
        upload_to=blog_featured_upload_path,
        storage=get_blog_featured_storage,
        blank=True,
        null=True,
    ...
    image_medium = models.ImageField(
        upload_to=blog_medium_upload_path,
        storage=get_blog_featured_storage,
        blank=True,
        null=True,
    )
