...
urlpatterns = [
    ...
    path('complaints/', apis.ComplaintCreateAPIView.as_view(), name='complaints'),
    path('catalog/', apis.CatalogAPIView.as_view(), name='catalog'),
    path('cities/', apis.CitiesAPIView.as_view(), name='cities'),
    path('locations/', apis.LocationsAPIView.as_view(), name='locations'),
    path('places/autocomplete/', apis.PlacesAutocompleteAPIView.as_view(), name='places-autocomplete'),
